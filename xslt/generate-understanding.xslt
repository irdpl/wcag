...
<xsl:template name="replaceUnsafeChars">
  ...
  <xsl:variable name="outputString" select="$inputString"/>
  
  <!-- Iterate over each replacement -->
  <xsl:for-each select="document('')//replace">
    <xsl:variable name="fromChar" select="@from"/>
    <xsl:variable name="toChar" select="@to"/>
    
    <!-- Replace each occurrence of the 'from' character with the 'to' character -->
    <xsl:variable name="outputString" select="translate($outputString, $fromChar, $toChar)"/>
  </xsl:for-each>
